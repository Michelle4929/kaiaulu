...
# Reads 2 configs
project <- parse_config("../conf/helix_immutable.yml")
analysis <- parse_config("../conf/analysis1.yml")

# Used for project.yml
project_path <- get_understand_project_path(project)

# Used for analysis.yml
keep_dependencies_type <- get_understand_keep_dependencies_type(analysis)

# keep_dependencies_type <- get_understand_keep_dependencies_type(conf)
# project_path <- get_understand_project_path(conf)

# Scitools
understand_folder <- get_understand_output_path(project)
code_language <- get_understand_code_language(project)
