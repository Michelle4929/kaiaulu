...
# Reads 2 configs
# project <- parse_config("../conf/kaiaulu_immutable.yml")
# analysis <- parse_config("../conf/analysis2.yml")
=======
# conf <- parse_config("../conf/helix.yml")
...
>>>>>>> d89a234 (Save work before switching to issue 359 branch)
...
# git_branch <- get_git_branches(project)[1]
# nvdfeed_folder_path <- get_nvdfeed_folder_path(project)
